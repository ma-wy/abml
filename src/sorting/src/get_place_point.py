...
#=======output==================================================================================
    self.grasping_point_pub = rospy.Publisher("/grasping_target_point", Point32, queue_size=1)
    self.handle_point_pub = rospy.Publisher("/handle_target_point", Point32, queue_size=1)
#===============================================================================================
# members
#311.867 254.023 
#369.615 552.456 460.460 520.072 336.453 172.203 245.607 204.587
  ...
  def callback_rgb(self, data):
    ...
    cv2.setMouseCallback('place', self.on_mouse)
...
def main(args):
  ...
  rospy.init_node('get_place_point', anonymous=True)
  cv2.namedWindow('place')
  print('Left: grasping target point')
  print('Middle: handle target point')
  gp = grasping_point()
  
  while not rospy.is_shutdown():
    cv2.imshow("place", gp.blank_image)    
