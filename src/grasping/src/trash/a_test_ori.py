...
joints = deg_to_rad(joints)
joints = [1.6547185198089531, -0.8348417273989895, 0.16307713018628733, -2.5923274556544786, 0.12237122779495671, 1.7578194697076062, 0.955733376322521]
#rob.go(joints)
...
if axis == 'x':
  ...
  target.position.z += d
#rob.go(pose)
#print(rob.get_current_joint_values())
#final_pose = get_PoseStamped(rob.get_current_pose())
