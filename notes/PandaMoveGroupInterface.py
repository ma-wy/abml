...
class PandaMoveGroupInterface:
    ...
    def __init__(self, use_panda_hand_link=True):
        print("##################################################################### Zoe Test")
        print("###### Check the initialization of PandaMoveGroupInterface ##########")
        try: #(check)
        ...
        try: #(check)
            ...
            self._gripper_group = moveit_commander.MoveGroupCommander("panda_hand") #callable
        except KeyError:
        ...
        if use_panda_hand_link and self._gripper_group is not None: #(check)
        ...
        if self._arm_group.get_end_effector_link() is not None:
            print("###### PandaMoveGroupInterface successfuly ends ######")
        print("##################################################################### Zoe Test")
