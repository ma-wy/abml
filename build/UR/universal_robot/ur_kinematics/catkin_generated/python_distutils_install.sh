...
echo_and_run cd "/home/abml/zoe_ws/src/UR/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abml/zoe_ws/src/UR/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/abml/zoe_ws/build/UR/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
