...
echo_and_run cd "/home/abml/zoe_ws/src/UR/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abml/zoe_ws/src/UR/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/abml/zoe_ws/build/UR/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
