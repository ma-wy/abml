...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_ros_controllers;/home/abml/libfranka/build/libfranka.so.0.9.2".split(';') if "-lfranka_ros_controllers;/home/abml/libfranka/build/libfranka.so.0.9.2" != "" else []
