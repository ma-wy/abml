...
echo_and_run cd "/home/abml/zoe_ws/src/franka_ros_interface/franka_moveit"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abml/zoe_ws/src/franka_ros_interface/franka_moveit/setup.py" \
     \
    build --build-base "/home/abml/zoe_ws/build/franka_ros_interface/franka_moveit" \
    install \
    --root="${DESTDIR-/}" \
