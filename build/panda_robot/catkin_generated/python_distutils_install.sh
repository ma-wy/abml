...
echo_and_run cd "/home/abml/zoe_ws/src/panda_robot"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abml/zoe_ws/src/panda_robot/setup.py" \
    egg_info --egg-base /home/abml/zoe_ws/build/panda_robot \
    build --build-base "/home/abml/zoe_ws/build/panda_robot" \
    install \
    --root="${DESTDIR-/}" \
