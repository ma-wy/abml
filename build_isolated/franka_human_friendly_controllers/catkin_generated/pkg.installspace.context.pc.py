...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_human_friendly_controllers;/opt/ros/noetic/lib/x86_64-linux-gnu/libfranka.so.0.9.2".split(';') if "-lfranka_human_friendly_controllers;/opt/ros/noetic/lib/x86_64-linux-gnu/libfranka.so.0.9.2" != "" else []
PROJECT_NAME = "franka_human_friendly_controllers"
PROJECT_SPACE_DIR = "/home/abml/zoe_ws/install_isolated"
